/**
 * FavoritesTabScreen Tests
 *
 * Tests for FavoritesTabScreen component covering:
...
describe('FavoritesTabScreen', () => {
  ...
  it('renders without crashing', () => {
    ...
    const { container } = renderWithProviders(<FavoritesTabScreen />, {
      authContext: {
        profile,
        user: {
          id: profile.id,
  ...
  it('calls useFavoriteLocations hook', () => {
    ...
    renderWithProviders(<FavoritesTabScreen />, {
      authContext: { profile },
    })
  ...
  it('renders when latitude is missing', () => {
    mockUseLocation.mockReturnValue({
      latitude: null,
      longitude: -74.006,
      accuracy: 10,
  ...
  it('renders when longitude is missing', () => {
    mockUseLocation.mockReturnValue({
      latitude: 40.7128,
      longitude: null,
      accuracy: 10,
