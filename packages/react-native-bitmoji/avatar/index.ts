 ...
 * Usage:
 * ```tsx
 * import { Avatar, AvatarConfig, HairStyle, EyeStyle } from './avatar';
 *
...
// Facial proportions type
export type { FacialProportions } from './types';
...
export type { AvatarPreset, PresetCategory } from './presets';
...
// QA System (for development/testing)
