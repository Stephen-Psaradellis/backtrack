...
export const EventCard = memo(function EventCard({
  ...
  const containerClasses = [
    ...
    // Interactive styles
    onPress
      ? 'cursor-pointer hover:border-pink-300 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2'
      : '',
    // Size variants
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {showPostCount && event.post_count !== undefined && event.post_count > 0 && (
            <span
              className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300"
...
export const FeaturedEventCard = memo(function FeaturedEventCard(
  ...
  return (
    <EventCard
      {...props}
      className={`ring-2 ring-pink-500 ring-offset-2 ${props.className ?? ''}`}
